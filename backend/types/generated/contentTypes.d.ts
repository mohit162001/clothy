...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    new_price: Attribute.Float & Attribute.DefaultTo<0>;
    old_price: Attribute.Float & Attribute.Required & Attribute.DefaultTo<0>;
    ...
    new_collection: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::product.product',
